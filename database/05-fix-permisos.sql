...
-- Ejecutar para corregir permisos según roles
-- Fecha: 19/11/2025
-- =====================================================
...
-- Si no existen las tablas de permisos, ejecutar primero 03-rbac-permissionss.sql
...
SELECT 'VERIFICACIÓN: Aprendices con permisos incorrectos' as verificacion;
...
SELECT 'VERIFICACIÓN: Portería con permisos de gestión de equipos' as verificacion;
SELECT p.nombre_permiso
FROM role_perm rp
INNER JOIN permisos p ON rp.id_permiso = p.id_permiso
WHERE rp.id_rol = 6
