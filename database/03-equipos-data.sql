-- =====================================================
-- SISTEMA ATLAS - DATOS DE EQUIPOS (FASE 3)
-- =====================================================
-- 
-- Este archivo contiene datos adicionales de equipos:
...
-- =====================================================
-- 
-- Ejecutar después de: 02-rbac-permissions.sql
-- 
-- =====================================================
...
-- =====================================================
-- INSERTAR EQUIPOS DE PRUEBA ADICIONALES
-- =====================================================
...
(1, 2, 'entrada', DATE_SUB(NOW(), INTERVAL 2 HOUR), 'qr', 'Entrada registrada con código QR'),
(1, 2, 'salida', DATE_SUB(NOW(), INTERVAL 6 HOUR), 'qr', 'Salida al finalizar clases'),
(1, 2, 'entrada', DATE_SUB(NOW(), INTERVAL 8 HOUR), 'qr', 'Entrada por la mañana');

-- Equipo 2: Fuera del centro (última salida)
INSERT INTO registros_acceso (id_equipo, id_portero, tipo_registro, fecha_hora, metodo_verificacion, observaciones) VALUES
(2, 2, 'entrada', DATE_SUB(NOW(), INTERVAL 10 HOUR), 'qr', 'Entrada con código QR'),
(2, 2, 'salida', DATE_SUB(NOW(), INTERVAL 1 HOUR), 'qr', 'Salida registrada correctamente');

-- Equipo 3: Dentro del centro
INSERT INTO registros_acceso (id_equipo, id_portero, tipo_registro, fecha_hora, metodo_verificacion, observaciones) VALUES
(3, 2, 'entrada', DATE_SUB(NOW(), INTERVAL 3 HOUR), 'manual', 'Entrada manual - QR no disponible');

-- Equipo 4: Dentro del centro
INSERT INTO registros_acceso (id_equipo, id_portero, tipo_registro, fecha_hora, metodo_verificacion, observaciones) VALUES
(4, 2, 'entrada', DATE_SUB(NOW(), INTERVAL 5 HOUR), 'numero_serie', 'Entrada por número de serie');

-- Equipo 7: Dentro del centro
INSERT INTO registros_acceso (id_equipo, id_portero, tipo_registro, fecha_hora, metodo_verificacion, observaciones) VALUES
(7, 2, 'entrada', DATE_SUB(NOW(), INTERVAL 12 HOUR), 'qr', 'Entrada de administración');
