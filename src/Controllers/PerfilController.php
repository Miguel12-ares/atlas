<?php
/**
 * Sistema Atlas - Controlador de Perfil
 * 
...
class PerfilController extends Controller
{
    ...
    public function show(): void
    {
        ...
        $this->renderEnConstruccion('Mi Perfil');
    }
            ...
            <div class="container">
                <div class="content">
                    ...
                    <div class="info-box">
                        ...
                        <p><strong>Usuario Actual:</strong> <?= htmlspecialchars($user['nombres'] . ' ' . $user['apellidos']) ?></p>
                        <p><strong>Rol:</strong> <?= htmlspecialchars($user['nombre_rol']) ?></p>
                    </div>

                    <p style="font-size: 0.95rem; color: #999;">
                        La Fase 2 (Autenticación y Roles) está completamente funcional. 
                        La gestión completa del perfil se implementará en fases posteriores.
                    </p>
