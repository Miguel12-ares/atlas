<?php
/**
 * Sistema Atlas - Controlador de Usuarios
 * 
...
class UsuarioController extends Controller
{
    ...
    public function index(): void
    {
        ...
        // Verificar permisos
        Middleware::requirePermission('usuarios.leer');

        // Por ahora, mostrar página en construcción
        $this->renderEnConstruccion('Gestión de Usuarios');
    }
    ...
    public function show(int $id): void
    {
        ...
        // Por ahora, mostrar página en construcción
        $this->renderEnConstruccion('Detalle de Usuario');
    }
    ...
    public function create(): void
    {
        ...
        // Verificar permisos
        Middleware::requirePermission('usuarios.crear');

        // Por ahora, mostrar página en construcción
        $this->renderEnConstruccion('Crear Usuario');
    }
    ...
    public function edit(int $id): void
    {
        ...
        // Verificar permisos
        Middleware::requirePermission('usuarios.actualizar');

        // Por ahora, mostrar página en construcción
        $this->renderEnConstruccion('Editar Usuario');
    }
    ...
    public function delete(int $id): void
    {
        ...
        // Verificar permisos
        Middleware::requirePermission('usuarios.eliminar');
